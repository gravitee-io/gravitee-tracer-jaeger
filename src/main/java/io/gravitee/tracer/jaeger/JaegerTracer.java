...
public class JaegerTracer extends AbstractService<Tracer> implements VertxTracer<Scope, Scope> {
    ...
    protected void doStart() throws Exception {
        ...
        if (configuration.isSslEnabled()) {
            ...
            if (configuration.getTruststoreType() != null) {
                if (configuration.getTruststoreType().equalsIgnoreCase(KEYSTORE_FORMAT_JKS)) {
                    ...
                    options.setPemTrustOptions(
                            new PemTrustOptions()
                                    .addCertPath(configuration.getTruststorePath())
                    );
                }
            }
            ...
            channelBuilder.sslContext(new DelegatingSslContext(ctx) {
        ...
        final JaegerGrpcSpanExporter exporter =
        ...
        Resource serviceNameResource =
                Resource.create(Attributes.of(AttributeKey.stringKey("service.name"), node.application()));
